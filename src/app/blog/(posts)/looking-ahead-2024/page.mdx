...
- [Babel](https://babeljs.io/) 🔜 [SWC](https://swc.rs/) written in Rust.
- [Webpack](https://webpack.js.org/) 🔜 [esbuild](https://esbuild.github.io/) written in Go / [Turbopack](https://vercel.com/blog/turbopack) written in Rust / [Rspack](https://www.rspack.dev/) written in Rust.
- [ESLint](https://eslint.org/) 🔜 [Oxlint](https://oxc-project.github.io/docs/guide/usage/linter.html) written in Rust.
- [Prettier](https://prettier.io/) 🔜 [Biome](https://biomejs.dev/) written in Rust.
- Node.js 🔜 [Bun](https://bun.sh/) written in Zig.
