...
import TwoVariables from "./two-variables.svg";
...
<TwoVariables
  className="w-full"
  aria-label="developer and person variable pointing at the same object reference in memory"
/>
...
<Image
  src={points}
  alt="person and personClone are still pointing to the same reference internally"
/>
