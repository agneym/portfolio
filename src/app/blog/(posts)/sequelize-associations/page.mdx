...
import foreignKey from "./foreign-key.png";
import manyToMany from "./many-to-many.png";
...
<Image
  src={foreignKey}
  alt="User model with foreign key relation of profile_id to Profile model id"
/>
...
<Image
  src={oneToOne}
  alt="Example of one to one relationship with User and Profile connected to each other"
/>
...
<Image
  src={oneToMany}
  alt="Example of one to many relationship with User and Commments connected to each other"
/>
...
<Image
  src={manyToMany}
  alt="Example of many to many relationship with User and Books connected to each other"
/>
