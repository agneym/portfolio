...
The caveat here is the `!important` keyword. Before I explain why this keyword matters, we need to understand its function.

Whenever you find that the steps in the cascade aren't helping and you can no longer increase specificity, but still need the style to be applied, you use the `!important` keyword.
