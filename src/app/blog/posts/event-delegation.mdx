...
import { BubblingVisualizer } from "./src/components/BlogHome/PostComponents/BubblingVisualizer";
import { EventDelegationCode } from "./src/components/BlogHome/PostComponents/EventDelegationCode";
import { PropagationVisualizer } from "./src/components/BlogHome/PostComponents/PropagationVisualizer";
import { SynEventViewer } from "./src/components/BlogHome/PostComponents/SynEventViewer";
import { PlaygroundWrapper as Playground } from "./src/components/uikit/PlaygroundWrapper";
...
- [Event](#event)
  - [Event propagation](#event-propagation)
    ...
    - [Not every event will bubble](#not-every-event-will-bubble-)
  - [Event delegation](#event-delegation)
  - [event stopPropagation](#event-stoppropagation)
  - [event stopImmediatePropagation](#event-stopimmediatepropagation)
- [Synthetic Events - React's Event System](#synthetic-events-reacts-event-system)
  - [How does React achieve this?](#how-does-react-achieve-this)
  - [How do we access the native event object?](#how-do-we-access-the-native-event-object)
  - [What is the difference between `event.stopPropagation()` and `event.nativeEvent.stopPropagation()`?](#what-is-the-difference-between-eventstoppropagation-and-eventnativeeventstoppropagation)
  - [Explaining the logs](#explaining-the-logs)
